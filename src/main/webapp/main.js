...
module.exports = __webpack_require__(/*! C:\werkplaats\angulardemo-main\src\main.ts */"zUnb");
...
class FrameworkDaoService {
    constructor(httpClient) {
        ...
        this.url = 'http://localhost:9080/Jax-RS-1.0-SNAPSHOT/resources/frameworks';
    }
    getFrameworks() {
        let observable;
